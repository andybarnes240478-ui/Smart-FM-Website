      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
            Purpose-built software for field services, quoting, compliance, and asset strategy — plus hands-on delivery when you need it. Built by FM practitioners. Priced for real teams.
          </p>
          ...
          <p className="text-gray-500 text-sm">
            Works alongside MaintainX, Corrigo, Maximo, and others
          </p>
        </div>
      </div>
    </section>
